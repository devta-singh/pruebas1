...
$pdf->Cell(0,5,"$fecha ($ahora) - IP: $ip - CirculoDeSanacion.Org", 0, 2);
$pdf->Cell(0,7,"$nav");
...
/*
$pdf->Image($imagen,10,$y,-300);
$pdf->Image($imagen,105,$y,-300);
